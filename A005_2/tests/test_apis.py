...
class TestTradesAPI:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("TESTE", datetime.datetime(2019, 1, 1), datetime.datetime(2019, 1, 2),
             "https://www.mercadobitcoin.net/api/TESTE/trades/1546318800/1546405200"),
            ("TESTE", datetime.datetime(2021, 6, 12), datetime.datetime(2021, 6, 15),
             "https://www.mercadobitcoin.net/api/TESTE/trades/1623470400/1623729600"),
            ("TESTE", None, None,
             "https://www.mercadobitcoin.net/api/TESTE/trades"),
            ("TESTE", None, datetime.datetime(2021, 6, 12),
             "https://www.mercadobitcoin.net/api/TESTE/trades"),
            ("TESTE", datetime.datetime(2021, 6, 12), None,
    ...
    def test_get_endpoint_since_greater_than_until(self):
        with pytest.raises(RuntimeError):
            TradesApi("TESTE")._get_endpoint(datetime.datetime(2021, 6, 15), datetime.datetime(2021, 6, 12))
